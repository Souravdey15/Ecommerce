<?php
use \Qblocks\Service\StripePayment;
            ...
            <form id="frmStripePayment" action=""
                ...
                <div class="field-row">
                    ...
                    <div class="contact-row cvv-box">
                        <label>CVV</label> <span id="cvv-info"
                            class="info"></span><br> <input type="text"
                            name="cvv" id="cvv" maxlength="3" size="3"
...
Stripe.setPublishableKey("<?php echo pk_test_U8xBxW5MaeiNj5ssxgMHbn6c00wcPKLuPt; ?>");
Stripe.setSecrectKey("<? echo sk_test_TFMwIfqmePAbYnk3wSQoT5Tr009A6F3DXI?>");
